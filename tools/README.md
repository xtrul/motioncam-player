...
`mcraw_preview.sh` creates a temporary thumbnail for a single `.mcraw` file and
opens it with your system's default image viewer:

```
./mcraw_preview.sh <file.mcraw>
```

The generated PNG is stored in your temporary directory so you don't have to
