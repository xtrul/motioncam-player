...
private:
    ...
    enum class LevelPreset {
        DYNAMIC,        // Use dynamic levels from metadata
        STATIC,         // Use static 0/65535
        BIT10_64,       // 1023/64
        BIT12_256,      // 4095/256
        BIT14_1024,     // 16383/1024
        BIT16_4096,     // 65535/4096
        BIT12_64,       // 4095/64
        BIT14_64,       // 16383/64
        BIT14_0         // 16383/0
    };
    LevelPreset m_levelPreset = LevelPreset::DYNAMIC;
    float m_gamma = 1.0f;  // Gamma correction (1.0 = linear)
    ...
    bool m_showUI = true;
    bool m_manualUIToggle = false; // Track if user manually toggled UI
    std::chrono::steady_clock::time_point m_lastUIActivity;
    ...
    void updateUIAutoHide();
    void resetUIActivity();
