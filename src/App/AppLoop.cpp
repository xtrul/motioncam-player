...
void App::drawFrame() {
    ...
    if (renderContentFromPacket) {
        ...
        // Apply black/white level preset
        bool useDynamicLevels = false;
        switch (m_levelPreset) {
            case LevelPreset::DYNAMIC:
                // Use metadata values (handled in Renderer_VK) with default fallback
                m_staticBlack = 0.0;
                m_staticWhite = 65535.0;
                useDynamicLevels = true;
                break;
            case LevelPreset::STATIC:
                m_staticBlack = 0.0;
                m_staticWhite = 65535.0;
                break;
            case LevelPreset::BIT10_64:
                m_staticBlack = 64.0;
                m_staticWhite = 1023.0;
                break;
            case LevelPreset::BIT12_256:
                m_staticBlack = 256.0;
                m_staticWhite = 4095.0;
                break;
            case LevelPreset::BIT14_1024:
                m_staticBlack = 1024.0;
                m_staticWhite = 16383.0;
                break;
            case LevelPreset::BIT16_4096:
                m_staticBlack = 4096.0;
                m_staticWhite = 65535.0;
                break;
            case LevelPreset::BIT12_64:
                m_staticBlack = 64.0;
                m_staticWhite = 4095.0;
                break;
            case LevelPreset::BIT14_64:
                m_staticBlack = 64.0;
                m_staticWhite = 16383.0;
                break;
            case LevelPreset::BIT14_0:
                m_staticBlack = 0.0;
                m_staticWhite = 16383.0;
                break;
        }
