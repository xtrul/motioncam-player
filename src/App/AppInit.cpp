...
App::App(const std::string& filePath) :
    ...
    m_showUI(true), m_manualUIToggle(false), m_lastUIActivity(std::chrono::steady_clock::now()),
...
bool App::initVulkan() {
    ...
    m_window = glfwCreateWindow(m_windowWidth, m_windowHeight, "MotionCam Player v1.0", nullptr, nullptr);
    if (!m_window) {
