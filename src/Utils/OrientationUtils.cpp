...
// Mapping used by MotionCam's ScreenOrientation enum
// 0: PORTRAIT, 1: REVERSE_PORTRAIT, 2: REVERSE_LANDSCAPE, 3: LANDSCAPE
static OrientationTag fromScreenOrientationEnum(int val, bool flipped) {
    switch(val) {
        case 0:  return flipped ? OrientationTag::kMirror90CW : OrientationTag::kRotate90CW;
        case 1:  return flipped ? OrientationTag::kMirror90CCW : OrientationTag::kRotate90CCW;
        case 2:  return flipped ? OrientationTag::kMirror180 : OrientationTag::kRotate180;
        case 3:  return flipped ? OrientationTag::kMirror : OrientationTag::kNormal;
        default: return OrientationTag::kUnknown;
    }
}
...
OrientationTag computeOrientationTag(const nlohmann::json& orientationValue,
    ...
    if (val.is_number_integer()) {
        ...
        // ScreenOrientation enum used by MotionCam (0=PORTRAIT,1=REVERSE_PORTRAIT,2=REVERSE_LANDSCAPE,3=LANDSCAPE)
        if (iv >= 0 && iv <= 3) {
            OrientationTag t = fromScreenOrientationEnum(iv, isFlipped);
