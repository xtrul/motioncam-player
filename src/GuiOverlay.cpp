...
void GuiOverlay::render(App* appInstance) {
    ...
    if (ui.showHelpPage) {
        ...
        if (ImGui::Begin("Help - Keyboard Shortcuts", &help_open_flag, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoSavedSettings)) {
            ...
            ImGui::Separator(); ImGui::Text("Display & UI:");
            ...
            ImGui::BulletText("Middle Mouse Dbl-Click : Toggle 100% Zoom");
            ImGui::BulletText("Delete/Backspace : Move File to _deleted folder");
            ImGui::BulletText("[0]..[4]       : CFA Override (0 resets)");
