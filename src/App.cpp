        ...
        if (!j.is_null()) {
            if (j.is_number_integer()) {
                ...
                switch (v) {
                    ...
                    case 90: return flipped ? tinydngwriter::ORIENTATION_LEFTTOP : tinydngwriter::ORIENTATION_RIGHTTOP; // Portrait 90°
                    case -90: return flipped ? tinydngwriter::ORIENTATION_RIGHTBOT : tinydngwriter::ORIENTATION_LEFTBOT; // Reverse portrait
                    case 180: return flipped ? tinydngwriter::ORIENTATION_BOTLEFT : tinydngwriter::ORIENTATION_BOTRIGHT; // Reverse landscape
                    case 270: return flipped ? tinydngwriter::ORIENTATION_TOPRIGHT : tinydngwriter::ORIENTATION_TOPLEFT; // Landscape rotated
                }
            } else if (j.is_string()) {
                ...
                if (o == "90" || o == "90CW" || o == "CW90") return flipped ? tinydngwriter::ORIENTATION_LEFTTOP : tinydngwriter::ORIENTATION_RIGHTTOP;
                if (o == "-90" || o == "90CCW" || o == "CCW90" || o == "270") return flipped ? tinydngwriter::ORIENTATION_RIGHTBOT : tinydngwriter::ORIENTATION_LEFTBOT;
                if (o == "180") return flipped ? tinydngwriter::ORIENTATION_BOTLEFT : tinydngwriter::ORIENTATION_BOTRIGHT;
            }
        }
        return defTag;
    }
