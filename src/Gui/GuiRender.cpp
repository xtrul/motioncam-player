...
namespace GuiOverlay {
    ...
    void render(App* appInstance) {
        ...
        ImGui::PushStyleColor(ImGuiCol_ChildBg, ImVec4(40.0f / 255.0f,
                                                    40.0f / 255.0f,
                                                    40.0f / 255.0f,
                                                    1.0f));
        ...
        ImGui::PopStyleColor();
            ...
            if (appInstance->m_firstFileLoaded && appInstance->m_previewTex != 0)
                ImGui::Image((ImTextureID)appInstance->m_previewTex, innerSize, ImVec2(0,1), ImVec2(1,0));
