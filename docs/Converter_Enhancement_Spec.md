...
This document describes proposed improvements to the **MotionCam Converter** add‑on. The goal is to achieve feature parity with the export options available in MotionCam Converter and to improve overall usability.
